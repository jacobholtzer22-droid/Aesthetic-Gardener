...
export const metadata: Metadata = {
  ...
  description:
    'Weekly mowing, fertilization, weed control, aeration, and overseeding in Holland MI and West Michigan. Professional lawn care for lush, healthy yards.',
  openGraph: {
    title: 'Lawn Care & Maintenance | Aesthetic Gardener Holland MI',
    description:
      'Weekly mowing, fertilization, weed control in Holland & West Michigan. Keep your lawn lush and healthy.',
  ...
  return (
    <main className="min-h-screen">
        ...
        <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0">
            <Image
              ...
              alt="Professional lawn care and maintenance by Aesthetic Gardener Holland Michigan"
              fill
              sizes="100vw"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {offers.map((item, index) => (
              ...
              >
                <Image src={item.image} alt={`${item.title} - Lawn care in Holland MI`} fill sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw" className="object-cover transition-transform duration-500 group-hover:scale-105" loading="lazy" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
      ...
      <section className="relative py-24 bg-[#111111] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image src="/images/client/Freshmowedlawn.jpg" alt="Lawn care process - Aesthetic Gardener West Michigan" fill sizes="100vw" className="object-cover" loading="lazy" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChoose.map((item, index) => (
              ...
              >
                <Image src={item.image} alt={`${item.title} - Aesthetic Gardener lawn care`} fill sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 25vw" className="object-cover" loading="lazy" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
                <div className="absolute inset-0 bg-black/70 group-hover:bg-black/60 transition-colors duration-300" />
                <div className="relative p-8">
                  <h3 className="font-display text-xl font-bold text-white mb-3">{item.title}</h3>
                  <p className="text-gray-300 leading-relaxed">{item.description}</p>
      ...
      <section className="relative py-24 bg-[#1a1a1a] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image src="/images/client/generallawnlandscape2.jpg" alt="Lawn care quote - Holland MI professional mowing" fill sizes="100vw" className="object-cover" loading="lazy" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
