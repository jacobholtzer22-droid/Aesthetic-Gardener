...
export default function ContactPage() {
  return (
    <main className="min-h-screen">
      ...
      <section className="relative py-24 bg-gradient-to-br from-forest-50 via-sage-50 to-earth-50 overflow-hidden">
        {/* Decorative blobs */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-forest-200/30 blob" />
        <div
          className="absolute bottom-0 left-0 w-72 h-72 bg-sage-200/30 blob"
          style={{ animationDelay: '2s' }}
        />
        <div
          className="absolute top-1/2 right-1/4 w-48 h-48 bg-earth-200/25 blob"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8 animate-slide-up">
              <h1 className="font-display text-5xl lg:text-6xl font-bold text-forest-900">
                Get In Touch
              </h1>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-forest-900 mb-1">Address</div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-forest-900 mb-1">Hours</div>
                    <div className="text-lg text-sage-700">
              ...
              {/* Optional: Google Map */}
              <div className="rounded-[2rem] overflow-hidden shadow-xl border-2 border-white/50">
                <iframe
            ...
            <div className="bg-white rounded-[3rem] shadow-2xl p-8 lg:p-12 animate-slide-in-right stagger-2">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <label className="block text-sage-700 font-medium mb-2">Phone *</label>
                  <input
                    type="tel"
                ...
                <div>
                  <label className="block text-sage-700 font-medium mb-2">Service Type</label>
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-forest-600 to-forest-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-2xl hover:scale-[1.02] transition-all duration-300"
                >
                  Send Message
                </button>
      ...
      <section className="relative py-24 bg-white overflow-hidden">
        ...
        <div className="absolute top-10 left-0 w-64 h-64 bg-forest-100/50 blob" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-4xl font-bold text-forest-900 text-center mb-4">
            Service Areas
          </h2>
          <p className="text-sage-700 text-center max-w-2xl mx-auto mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {SERVICE_AREAS.map((area) => (
              <span
                key={area}
                className="inline-block bg-forest-50 text-forest-700 px-5 py-2.5 rounded-full text-sm font-medium border border-forest-200/60"
              >
                {area}
              </span>
            ))}
      ...
      <section className="relative py-24 bg-gradient-to-br from-forest-50 via-sage-50 to-earth-50 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-sage-200/30 blob" style={{ animationDelay: '1s' }} />
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-4xl font-bold text-forest-900 text-center mb-12">
          ...
          <div className="space-y-6">
            {FAQ_ITEMS.map((item, i) => (
              <div
                key={i}
                className="bg-white/80 backdrop-blur rounded-[2rem] p-6 lg:p-8 shadow-lg border border-sage-200/60"
              >
                <h3 className="font-display text-xl font-bold text-forest-900 mb-3">
                  {item.q}
                </h3>
                <p className="text-sage-700 leading-relaxed">{item.a}</p>
              </div>
            ))}
          </div>
        </div>
