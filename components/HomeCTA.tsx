  ...
  return (
    <section className="relative py-24 overflow-hidden">
      <div className="absolute inset-0">
        <Image src="/images/client/patiobricking2.jpg" alt="Brick patio and hardscaping by Aesthetic Gardener in Holland Michigan" fill sizes="100vw" className="object-cover" loading="lazy" placeholder="blur" blurDataURL={BLUR_DATA_URL} />
